...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    const onMouseMove = (e) => {
      ...
      // X: mouse derecha → SVG izquierda | Y: mouse arriba → SVG abajo (contrario)
    ...
    <section className="hero" ref={heroRef}>
      ...
      <div className="hero-left">
        <div className="hero-eyebrow">
          <span className="hero-dot"></span>Creatividad en la era de la IA
        </div>
        ...
        <div className="hero-sub">
          <div className="hero-subparrafo">Combinamos <strong>IA, estrategia y ejecución ágil</strong> en Google Ads, Meta Ads, TikTok Ads y LinkedIn Ads.<br /></div>
          <div className="hero-subparrafo">El crecimiento real no se intuye. Se estructura. Se valida. <strong>Se logra.</strong></div>
        </div>
      ...
      {/* Columna derecha: carrusel orbital de logos */}
