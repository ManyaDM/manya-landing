        ...
        <form className="lead-form reveal" onSubmit={handleSubmit}>
          <div className="form-row">
            <div className="form-group">
              ...
              <input type="text" placeholder="María García" required />
            </div>
            <div className="form-group">
              <label>Email empresarial</label>
              <input type="email" placeholder="maria@empresa.com" required />
            </div>
          </div>
          <div className="form-row">
            <div className="form-group">
            ...
            <div className="form-group">
              <label>Presupuesto mensual en ads</label>
          ...
          <div className="form-group">
            ...
            <textarea placeholder="Ej: Reducir el CPL actual de S/ 80 a S/ 30, escalar ventas de ecommerce de 200 a 600 unidades/mes, generar 50 leads calificados B2B por mes..." />
          </div>
